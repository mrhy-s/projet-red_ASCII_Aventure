...
func main() {
	...
	// initialisation
	items.Fer_brut = items.InitRessources("Fer brut", "Minerai de fer brut, utilisé pour faire des équipements")
	...
	// Skills monstres
	skills.Griffure = skills.InitSkill("[Spell book] > Griffure", "Gobelin", 0, "Inflige une griffure douloureuse")
	...
	items.Bottes_de_laventurier = items.InitArmure("Bottes de l'aventurier", "any", 0, 80, 80, "Bottes en cuir simples")
	items.Tunique_de_laventurier = items.InitArmure("Tunique de l'aventurier", "any", 0, 100, 100, "Tunique en cuir simples")
	items.Chapeau_de_laventurier = items.InitArmure("Chapeau de l'aventurier", "any", 0, 70, 70, "Chapeau en cuir simples")
	items.Épée_en_fer = items.InitArme("Épée en fer", "any", 1, 100, "Une épée solide forgée en fer, plus efficace que les armes de base", 15)
	...
	items.Dague_rouillée = items.InitArmeMonster("Dague rouillée", "any", 1, dague_rouillée_durabilité_Actuelle, dague_rouillée_durabilité_Max, "Lame ébrèchée mais encore tranchante", dague_rouillée_dégâts)
	...
	items.Gourdin_clouté = items.InitArmeMonster("Gourdin clouté", "any", 1, gourdin_clouté_durabilité_Actuelle, gourdin_clouté_durabilité_Max, "Bout de bois avec des clous tordus", gourdin_clouté_dégâts)
	...
	items.Arc_tordu = items.InitArmeMonster("Arc tordu", "any", 1, arc_tordu_durabilité_Actuelle, arc_tordu_durabilité_Max, "Arc mal façonné, flèches de fortune", arc_tordu_dégâts)
	...
	items.Cuir_bouilli_rapiécé = items.InitArmure("Cuir bouilli rapiécé", "any", 1, cuir_bouilli_durabilité_Max, cuir_bouilli_durabilité_Actuelle, "Armure de cuir mal entretenue")
	...
	items.Casque_bosselé = items.InitArmure("Casque bosselé", "any", 1, casque_bosselé_durabilité_Max, casque_bosselé_durabilité_Actuelle, "Heaume déformé et rouillé")
